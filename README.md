...
| `OpinionatedEventing.CloudEvents` | [![NuGet](https://img.shields.io/nuget/v/OpinionatedEventing.CloudEvents.svg)](https://www.nuget.org/packages/OpinionatedEventing.CloudEvents) | CloudEvents 1.0 structured-envelope mapping — no broker dependency |
| `OpinionatedEventing.CloudEvents.AzureServiceBus` | [![NuGet](https://img.shields.io/nuget/v/OpinionatedEventing.CloudEvents.AzureServiceBus.svg)](https://www.nuget.org/packages/OpinionatedEventing.CloudEvents.AzureServiceBus) | Opt-in CloudEvents envelope for the Azure Service Bus transport |
| `OpinionatedEventing.CloudEvents.RabbitMQ` | [![NuGet](https://img.shields.io/nuget/v/OpinionatedEventing.CloudEvents.RabbitMQ.svg)](https://www.nuget.org/packages/OpinionatedEventing.CloudEvents.RabbitMQ) | Opt-in CloudEvents envelope for the RabbitMQ transport |
